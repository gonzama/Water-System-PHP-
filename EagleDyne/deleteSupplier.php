		...
		.buttons
{
	...
	<body>
		...
		<h3 style="color:white">Delete Supplier</h3>
			...
			<input type="submit"  name="search" value="Search" style="background-color: #4CAF50;color: white;padding:8px 20px; margin:10px 0; border: none;cursor: pointer;width: 10%; ">			</div>
		...
		<table>
			...
			<tr>
				<td colspan="3">
					<input type="submit" name="delete" value="Delete" style="background-color: #4CAF50;color: white;padding: 15px 50px 15px 15px;margin-left: 150px;margin-top:10px;														  border: none;cursor: pointer;width: 10%;">
				</td>
			</tr>
		</table>
