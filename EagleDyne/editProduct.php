...
$sql = "UPDATE product SET pid = '".$_POST["pid"]."', pname ='".$_POST["PName"]."', type ='".$_POST["PType"]."', supplierId='".$_POST["sid"]."' where pid= '$id'" ;
		...
		.buttons
{
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3">
					<input type="submit" value="Update"  name="update"style="background-color: #4CAF50;color: white;padding: 15px 50px 15px 15px;margin-left: 150px;margin-top:10px;														  border: none;cursor: pointer;width: 10%;">
				</td>
			</tr>
		</table>		
